...
<html  >
    <head>
        ...
        <title>Browster - List barang</title>
                        ...
                        <div class="card-wrapper">
                            <div class="card-box align-center">
                                <h4 class="card-title mbr-fonts-style align-center mb-4 display-1">
                                    <strong>Pilih barangmu !</strong></h4>
                                <p class="mbr-text mbr-fonts-style mb-4 display-7">
                                    Kami memiliki banyak sekali pilihan barang yang siap anda sewa</p>
                            </div>
                        </div>
                    </div>
                </div>
                        ...
                        <div class="row align-items-center">
                            <div class="col-12 col-md-4">
                                <div class="image-wrapper">
                                    <?php echo '<img src="'. base_url().'uploads/'.$h->barang_foto.'"></img>'; ?>
                                </div>
                            </div>
                            <div class="col-12 col-md">
                                <div class="card-box">
                                    <div class="row">
                                        <div class="col-md">
                                            <h3>
                                                <strong><?php echo $h->barang_nama; ?></strong>
                                            </h3>
                                            </br>
                                            <br>
                                            <p class="mbr-text mbr-fonts-style display-7">
                                            <?php echo $h->barang_deskripsi; ?>
                                            </p>
                                        </div>
                                        <div class="col-md-auto">
                                            <p class="price mbr-fonts-style display-2"><?php echo 'Rp. '.number_format($h->barang_harga); ?></p>
                                            <div class="mbr-section-btn"><a href="<?php echo base_url().'frontend/dashboard/pinjam_add/'.$h->barang_id; ?>" class="btn btn-primary display-4">
                                                    Order Now
                                                </a></div>
                                        </div>
                                        <div></div>
