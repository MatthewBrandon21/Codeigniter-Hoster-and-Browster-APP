                    ...
                    <div class="col-12 col-md">
                        <div class="text-wrapper">
                            <h1 class="mbr-section-title mbr-fonts-style mb-3 display-2">
                                <strong>Selamat datang di Browster!</strong></h1>
                            <p class="mbr-text mbr-fonts-style display-7">
                                Tempat pinjam barang barang hobi!<br>Buruan order sebelum kehabisan!</p>
                            <div class="mbr-section-btn mt-3"><a class="btn btn-secondary display-4" href="<?php echo base_url().'cekbarang'; ?>">Cek barang</a>
        ...
        <section class="features4 cid-szL1IjXiH4" id="features4-2">
            ...
            <div class="container">
                <div class="mbr-section-head">
                    <h4 class="mbr-section-title mbr-fonts-style align-center mb-0 display-2"><strong>Mau pinjam apa?</strong></h4>
                </div>
                <div class="row mt-4">
                    <div class="item features-image сol-12 col-md-6 col-lg-4">
                        <div class="item-wrapper">
                            ...
                            <div class="item-content">
                                <h5 class="item-title mbr-fonts-style display-5"><strong>Console</strong></h5>
                            </div>
                            <div class="mbr-section-btn item-footer mt-2"><a href="<?php echo base_url().'barangconsole'; ?>" class="btn item-btn btn-black display-7" target="_blank">Start Now
                                    &gt;</a></div>
                        </div>
                    </div>
                    <div class="item features-image сol-12 col-md-6 col-lg-4">
                        <div class="item-wrapper">
                            ...
                            <div class="item-content">
                                <h5 class="item-title mbr-fonts-style display-5"><strong>Mainan</strong></h5>
                            </div>
                            <div class="mbr-section-btn item-footer mt-2"><a href="<?php echo base_url().'barangmainan'; ?>" class="btn item-btn btn-black display-7" target="_blank">Start Now
                                    &gt;</a></div>
                        </div>
                    </div>
                    <div class="item features-image сol-12 col-md-6 col-lg-4">
                        <div class="item-wrapper">
                            ...
                            <div class="item-content">
                                <h5 class="item-title mbr-fonts-style display-5"><strong>Pakaian</strong></h5>
                            </div>
                            <div class="mbr-section-btn item-footer mt-2"><a href="<?php echo base_url().'barangpakaian'; ?>" class="btn item-btn btn-black display-7" target="_blank">Start Now
                                    &gt;</a></div>
                        </div>
                    </div>
                    ...
                    <div class="col-md-12 col-lg-9">
                        <div class="card-wrapper pb-4">
                            <div class="card-box align-center">
                                <h4 class="card-title mbr-fonts-style mb-4 display-2"><strong>Cara Pinjam Barang</strong></h4>
                            </div>
                        </div>
                    </div>
                    <div class="col-12 col-md-8">
                        <div class="item mbr-flex">
                            ...
                            <div class="text-box">
                                ...
                                <h5 class="icon-text mbr-black mbr-fonts-style display-4">Register atau login untuk dapat order barang</h5>
                            </div>
                        </div>
                        <div class="item mbr-flex">
                            <div class="icon-box">
                            ...
                            <div class="text-box">
                                <h4 class="icon-title card-title mbr-black mbr-fonts-style display-7"><strong>Pilih barang</strong></h4>
                                <h5 class="icon-text mbr-black mbr-fonts-style display-4">Pilih barang dengan harga pinjam yang sangat miring&nbsp;</h5>
                            </div>
                        </div>
                        <div class="item mbr-flex">
                            <div class="icon-box">
                            ...
                            <div class="text-box">
                                ...
                                <h5 class="icon-text mbr-black mbr-fonts-style display-4">Selesaikan order dan kami akan mengirimkan barang ke anda</h5>
                            </div>
                        </div>
                        <div class="item mbr-flex last">
                            ...
                            <div class="text-box">
                                <h4 class="icon-title card-title mbr-black mbr-fonts-style display-7">
                                    <strong>Set pickup</strong></h4>
                                <h5 class="icon-text mbr-black mbr-fonts-style display-4">Setelah anda selesai menggunakannya, anda bisa set pickup barang agar kami datang mengambilnya</h5>
                            </div>
                        </div>
                    </div>
                </div>
