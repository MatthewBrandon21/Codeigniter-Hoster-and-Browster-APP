<aside class="main-sidebar sidebar-light-primary elevation-4">
    ...
    <a href="<?php echo base_url().'frontend/dashboard/index'; ?>" class="brand-link">
      <span class="brand-text font-weight-normal" style="padding-left: 20px;">       <b>Browster!</b> User Panel</span>
    </a>
    ...
    <div class="sidebar">
      ...
      <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item">
            <a href="<?php echo base_url().'frontend/dashboard/pinjam'; ?>" class="nav-link">
          ...
          <li class="nav-item">
            <a href="<?php echo base_url().'frontend/dashboard/barang'; ?>" class="nav-link">
