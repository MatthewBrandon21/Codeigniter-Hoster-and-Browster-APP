        ...
        <div class="row">
          <div class="col-lg-3 col-6">
            ...
            <div class="small-box bg-info">
              ...
              <a href="<?php echo base_url().'backend/dashboard/pinjam'; ?>" class="small-box-footer">More info <i class="fas fa-arrow-circle-right"></i></a>
            </div>
          </div>
          <!-- ./col -->
          <div class="col-lg-3 col-6">
            ...
            <div class="small-box bg-success">
              ...
              <a href="<?php echo base_url().'backend/dashboard/barang'; ?>" class="small-box-footer">More info <i class="fas fa-arrow-circle-right"></i></a>
            </div>
          </div>
          <!-- ./col -->
          <div class="col-lg-3 col-6">
              ...
              <div class="col-6">
                <div class="card shadow mb-4">
                  ...
                  <?php foreach($barang as $h){ ?>
                      <a href="backend/dashboard/barang" class="list-group-item list-group-item-action">
