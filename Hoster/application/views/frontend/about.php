            ...
            <div class="align-center container">
                <div class="row justify-content-center">
                    <div class="col-12 col-lg-10">
                        <h1 class="mbr-section-title mbr-fonts-style mb-3 display-1"><strong>Tentang Hoster!</strong></h1>
                        <p class="mbr-text mbr-fonts-style mb-3 display-7">
                            Hoster siap melayani anda untuk memenuhi kebutuhan liburan anda. Dengan Hoster anda dapat booking hotel dengan cepat dan mudah. Pilihan hotel yang ada di hoster juga sangat banyak dan di berbagai tempat. Cepat pilih hotel kesukaanmu dan check out!!</p>
                    </div>
                </div>
            </div>
        </section>
                ...
                <div class="row justify-content-center">
                    <div class="col-12 col-lg-10">
                        ...
                        <p class="mbr-text mbr-white mbr-fonts-style display-7">
                            Ayo pilih hotel tujuanmu! keburu kehabisan loh...</p>
                        <div class="mbr-section-btn mt-3"><a class="btn btn-danger display-4" href="<?php echo base_url().'cekhotel'; ?>">Cek Hotel</a></div>
                    </div>
                </div>
            </div>
        </section>
