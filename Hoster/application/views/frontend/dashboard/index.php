        ...
        <div class="row">
          <div class="col-lg-3 col-6">
            ...
            <div class="small-box bg-info">
              ...
              <a href="<?php echo base_url().'frontend/dashboard/booking'; ?>" class="small-box-footer">More info <i class="fas fa-arrow-circle-right"></i></a>
            </div>
          </div>
          <!-- ./col -->
          <div class="col-lg-3 col-6">
            ...
            <div class="small-box bg-success">
              ...
              <a href="<?php echo base_url().'frontend/dashboard/hotel'; ?>" class="small-box-footer">More info <i class="fas fa-arrow-circle-right"></i></a>
            </div>
          </div>
          <!-- ./col -->
          <div class="col-lg-3 col-6">
              ...
              <div class="col">
                <div class="card shadow mb-4">
                  ...
                  <?php foreach($hotel as $h){ ?>
                      <a href="hotel" class="list-group-item list-group-item-action">
