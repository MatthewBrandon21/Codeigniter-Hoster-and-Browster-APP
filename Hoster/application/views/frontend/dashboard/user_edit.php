          ...
          <div class="col-lg-9">
            <div class="card card-primary">
              ...
              <?php foreach($user as $u){ ?>
                <?php echo form_open_multipart(base_url().'/frontend/dashboard/user_update');?>
                ...
                <div class="card-body">
                  ...
                  <div class="form-group">
                    ...
                    <div class="col-sm-10"><input type="date" class="form-control" name="tgllahir" value="<?php echo $u->user_tgllahir; ?>"></div>
                  ...
                  <div class="form-group">
                  <?php echo '<img src="'. base_url().'uploads/'.$u->user_foto.'"height=100 width=100></img>'; ?>
                    </br>
                    </br>
                    <label>Photo</label>
